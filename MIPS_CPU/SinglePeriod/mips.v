			...
			7'h02:    Instruction <= {6'h02, 26'h0000067};
				//jal     KernelToUser
			...
			7'h45:    Instruction <= {6'h08, 5'd08, 5'd08, 16'h0000};
				//sw      $zero,   8($s7)          # TCON = 0
			...
			7'h5d:    Instruction <= {11'h00, 5'd00, 5'd00, 5'h00, 6'h00};
				//lw      $t3,     0x54($t4)            # get the digital scan choose number (high 4 bits)
			7'h5e:    Instruction <= {6'h23, 5'd12, 5'd11, 16'h0054};
				//add     $t2,     $t3, $t6             # add two number to get 12bits (port: digi)
			7'h5f:    Instruction <= {6'h00, 5'd11, 5'd14, 5'd10, 11'h20};
				//sw      $t2,     0x14($s7)            # write RAM and display the number
			7'h60:    Instruction <= {6'h2b, 5'd23, 5'd10, 16'h0014};
				//addi    $t3,     $zero,        3
			7'h61:    Instruction <= {6'h08, 5'd00, 5'd11, 16'h0003};
				//sw      $t3,     0x08($s7)            # TCON = 3
			7'h62:    Instruction <= {6'h2b, 5'd23, 5'd11, 16'h0008};
				//addi    $t4,     $t4,          4
			7'h63:    Instruction <= {6'h08, 5'd12, 5'd12, 16'h0004};
				//andi    $t4,     $t4,          0x0c   
			7'h64:    Instruction <= {6'h0c, 5'd12, 5'd12, 16'h000c};
				//sw      $t4,     0x50($zero) 
			7'h65:    Instruction <= {6'h2b, 5'd00, 5'd12, 16'h0050};
				//jr      $k0
			7'h66:    Instruction <= {6'h00, 5'd26, 21'h08};
				//j       Exception
			7'h67:    Instruction <= {6'h02, 26'h0000067};
