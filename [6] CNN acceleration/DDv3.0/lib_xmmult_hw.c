...
int Setup_HW_Accelerator(float A[INPUT_FM_SIZE], float B[PATTERN_ROW][PATTERN_COL], float res_hw[PATTERN_ROW][BLOCK_TO_ROW_ROW], int dma_size)
...
int Run_HW_Accelerator(float A[INPUT_FM_SIZE], float B[PATTERN_ROW][PATTERN_COL], float res_hw[PATTERN_ROW][BLOCK_TO_ROW_ROW], int dma_size)
